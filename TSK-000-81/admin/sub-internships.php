                                                ...
                                                try {
                                                    ...
                                                    foreach($rows as $row) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="edit-sub-intern.php?id=<?php echo $row["subId"] ?>"><i class="fa-solid fa-square-pen"></i></a>
                                                                <a href="del-sub-intern.php?id=<?php echo $row["subId"] ?>" class="ms-4"><i class="fa-solid fa-trash"></i></a>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                    }
